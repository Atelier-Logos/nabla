...
fn test_whitelisted_domains() {
    ...
    assert!(
        validator
            .validate_url("https://platform.atelierlogos.studio/marketplace/register")
            .is_ok()
    );
    assert!(
        validator
            .validate_url("https://aws.amazon.com/marketplace/listing")
            .is_ok()
    );
    assert!(
        validator
            .validate_url("https://api.together.xyz/v1/chat/completions")
            .is_ok()
    );
    assert!(
        validator
            .validate_url("https://huggingface.co/api/models")
            .is_ok()
    );
    ...
    assert!(
        validator
            .validate_url("https://malicious.example.com/")
            .is_err()
    );
    assert!(
        validator
            .validate_url("https://attacker.com/steal-data")
            .is_err()
    );
}
...
fn test_private_ip_blocking() {
    ...
    assert!(
        validator
            .validate_url("http://169.254.1.1:8080/api")
            .is_err()
    );
...
fn test_custom_whitelist() {
    ...
    config
        .whitelisted_domains
        .insert("custom-api.com".to_string());
    config
        .whitelisted_domains
    ...
    assert!(
        validator
            .validate_url("https://custom-api.com/v1/endpoint")
            .is_ok()
    );
...
fn test_subdomain_handling() {
    ...
    assert!(
        validator
            .validate_url("https://beta.api.openai.com/v1/chat/completions")
            .is_ok()
    );
    assert!(
        validator
            .validate_url("https://us-east-1.api.openai.com/v1/chat/completions")
            .is_ok()
    );
    ...
    assert!(
        validator
            .validate_url("https://openai.evil.com/api")
            .is_err()
    );
    assert!(
        validator
            .validate_url("https://fake-openai.com/api")
            .is_err()
    );
}
...
fn test_aws_marketplace_urls() {
    ...
    assert!(
        validator
            .validate_url("https://aws.amazon.com/marketplace/your-listing-id")
            .is_ok()
    );
    assert!(
        validator
            .validate_url("https://marketplace.amazonaws.com/some-listing")
            .is_ok()
    );
}
...
fn test_inference_server_urls() {
    ...
    assert!(
        validator
            .validate_url("http://127.0.0.1:11434/completion")
            .is_ok()
    );
    assert!(
        validator
    ...
    assert!(
        validator
            .validate_url("https://api.groq.com/openai/v1/chat/completions")
            .is_ok()
    );
}
...
fn test_huggingface_urls() {
    ...
    assert!(
        validator
            .validate_url("https://hf-mirror.com/api/models")
            .is_ok()
    );
    assert!(
        validator
            .validate_url("https://huggingface.co/microsoft/DialoGPT-medium")
            .is_ok()
    );
}
...
fn test_ssrf_attack_vectors() {
    ...
    assert!(
        validator
            .validate_url("http://169.254.169.254/latest/dynamic/instance-identity/document")
            .is_err()
    );
    assert!(
        validator
    ...
    assert!(
        validator
            .validate_url("http://169.254.169.254/metadata/v1/")
            .is_err()
    ); // DigitalOcean
    assert!(
        validator
    ...
    assert!(
        validator
            .validate_url("http://169.254.169.254/metadata/instance/v1/")
            .is_err()
    ); // Azure
...
fn test_url_manipulation_attempts() {
    ...
    assert!(
        validator
            .validate_url("https://api.openai.com@evil.com/api")
            .is_err()
    );
    assert!(
        validator
    ...
    assert!(
        validator
            .validate_url("https://api.openai.com%00.evil.com/api")
            .is_err()
    );
    ...
    assert!(
        validator
            .validate_url("https://api.openai.com%2Eevil.com/api")
            .is_err()
    );
    assert!(
        validator
            .validate_url("https://api.openai.com%00evil.com/api")
            .is_err()
    );
}
